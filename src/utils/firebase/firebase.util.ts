...
import { AdditionalInfo } from "../../store/user/user.action";
...
export const signInAuthWithEmailAndPassword=  (email:string, password:string)=>{
    if (!email || !password) return
...
export const addCollectionsAndDocuments = async <T extends ObjectToAdd>(collectionKey:string, objects:T[])=>{
